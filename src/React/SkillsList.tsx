...
const SkillsList = () => {
  ...
  const skills = {
    "AI/ML Engineering": [
      "Multi-agent & agentic AI orchestration",
    ...
    "Backend Engineering": [
      ...
      "Containerized deployment & data pipelines",
    ],
  };
        ...
        {Object.entries(skills).map(([category, items]) => (
          <li key={category} className="w-full">
            <div
              ...
              className="md:w-[400px] w-full bg-[var(--component-bg)] rounded-2xl text-left hover:bg-opacity-80 transition-all border border-[var(--component-border)] cursor-pointer overflow-hidden"
            >
